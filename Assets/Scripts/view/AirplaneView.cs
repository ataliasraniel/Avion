...
public class AirplaneView : MonoBehaviour
{
  ...
  public void InjectData()
  {
    ...
    if (TryGetComponent<Propeller>(out Propeller propeller))
    {
      ...
      propeller.rpmChangeMultiplier = airplaneData.rpmMultiplier;
      propeller.speedKM = airplaneData.propSpeedMultiplier;
      propeller.reverseThrustMultiplier = airplaneData.reverseSpeedMultiplier;
    }
